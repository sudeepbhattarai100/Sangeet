package sudeep.com.sangeet.Utility;
...
public class AppUtility {
    ...
    public static final String MUSIC_LIST_RECEIVED ="sudeep.com.sangeet.Utility.AppUtility";
    public static final String MUSIC_LIST = "sudeep.com.sangeet.Utility.MUSIC_LIST";

    public static final String CURRENT_INDEX= "sudeep.com.sangeet.Utility.CURRENT_INDEX";
    public static final int MUSIC_ACTIVITY_REQ_CODE = 22;

    public static final String DOWNLOAD_SERVICE_FILE_NAME = "sudeep.com.sangeet.Utility.DOWNLOAD_SERVICE_FILE_NAME";
    public static final String DOWNLOAD_SERVICE_URL = "sudeep.com.sangeet.Utility.DOWNLOAD_SERVICE_FILE_NAME.";
    public static final String MUSIC_PLAYING = "sudeep.com.sangeet.Utility.MUSIC_PLAYING";
